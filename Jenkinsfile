pipeline {
    ...
    agent {
        dockerfile {
            additionalBuildArgs '--build-arg JENKINS_USER_ID="${JENKINS_USER_ID}" --build-arg JENKINS_GROUP_ID=117 --build-arg http_proxy=${HTTP_PROXY} --build-arg https_proxy=${HTTP_PROXY}'
